...
```bash
uv run python ./totalspineseg_inference.py --config ./segment_example_dataset.yaml --image-weight T1w --totalspineseg-data-dir ./../../totalspineseg-data/ --device cuda --no-totalspineseg-quiet
```
